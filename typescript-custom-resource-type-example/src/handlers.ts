...
const createSimplifiedLogger = (logger: LoggerProxy) => {
  return (o: any) => {
    const output = JSON.stringify(o, null, 2);
    logger.log(output);
    console.log(output);
  };
};
...
class Resource extends BaseResource<ResourceModel> {
  ...
  public async create(
    ...
    >(model);
    // TODO: put code here
    const l = createSimplifiedLogger(logger);

    l({ session, request });

    model.tPSCode = `typescript-custom-resource-type-example-stack-01-MyResource-615d6dbb41ab`;
